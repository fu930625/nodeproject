...
Register.btnTemp = `
	<li>
		<a href='javascript:;' data-toggle='modal' data-target='.js-reg-modal' style="outline:none">
			注册
		</a>
	</li>`;
...
$.extend(Register.prototype,{
	...
	bindEvents:function(){
		...
		submitBtn.on("click",$.proxy(this.handleSumitBtnClick,this))
	},
	handleSumitBtnClick:function(){
		var username = this.model.find(".js-user").val();
		var password = this.model.find(".js-pass").val();
	...
	handleRegisterSucc:function(res){
		//ret是指服务器正常返回，res.data.register注册是否成功
